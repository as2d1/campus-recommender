        ...
        rows.append(
            {
                ...
                "user_level_title": str(first_non_empty(comment.get("user_level_title"), default="普通用户")),
            ...
            rows.append(
                {
                    ...
                    "user_level_title": str(first_non_empty(reply.get("user_level_title"), default="普通用户")),
            ...
            users.append(
                {
                    "user_id": author_id,
                    "nickname": nickname,
                    "user_level": to_int(first_non_empty(detail.get("user_level"), list_item.get("user_level"), default=1), 1),
                    "user_level_title": str(first_non_empty(detail.get("user_level_title"), list_item.get("user_level_title"), default="普通用户")),
                    "grade": "",
                    "college": "",
                    "major": "",
                    "campus": "",
                    "interest_tags": "|".join(tags[:4]),
                    "register_time": (publish_time - pd.Timedelta(days=120)).strftime("%Y-%m-%d %H:%M:%S"),
                    "is_new_user": 0,
